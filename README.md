...
<p align="center">
  <b>Selecione o idioma / Select language / Seleccione el idioma / Sélectionnez la langue / Seleziona la lingua / Sprache wählen</b><br>
...
> **Observação:** Este repositório refere-se à versão **v0.1.2.1** do Projeto Linceu Lighthouse. Apoie o projeto e adquira a versão paga através do link: [Instalar via Microsoft Store](https://apps.microsoft.com/detail/9NN8Z5Z700TM)
...
<details>
<summary><b>📂 source/gui/ - Camada de Interface Gráfica</b></summary>
...
<details>
<summary><b>📂 source/services/ - Camada de Lógica de Negócio</b></summary>
...
<details>
<summary><b>📂 source/ui/ - Componentes de Interface Avançados</b></summary>
...
<details>
<summary><b>📂 source/data/ - Geração de Estatísticas e Gráficos</b></summary>
...
<details>
<summary><b>📂 source/tools/ - Ferramentas e Utilitários de UI</b></summary>
...
<details>
<summary><b>📂 source/utils/ - Utilitários Transversais</b></summary>
...
<details>
<summary><b>📂 source/locale/ - Internacionalização</b></summary>
...
<details>
<summary><b>Monitoramento em Tempo Real</b></summary>
...
<details>
<summary><b>Extração de Metadados (47 módulos especializados)</b></summary>
...
<details>
<summary><b>Visualização de Dados (18 tipos de gráficos)</b></summary>
...
<details>
<summary><b>Exportação de Dados</b></summary>
...
> **Note:** This repository refers to the **v0.1.2.1** version of the Linceu Lighthouse Project. Support the project and purchase the paid version through the link: [Install via Microsoft Store](https://apps.microsoft.com/detail/9NN8Z5Z700TM)
...
<details>
<summary><b>📂 source/gui/ - Graphical Interface Layer</b></summary>
...
<details>
<summary><b>📂 source/services/ - Business Logic Layer</b></summary>
...
<details>
<summary><b>📂 source/ui/ - Advanced Interface Components</b></summary>
...
<details>
<summary><b>📂 source/data/ - Statistics and Chart Generation</b></summary>
...
<details>
<summary><b>📂 source/tools/ - UI Tools and Utilities</b></summary>
...
<details>
<summary><b>📂 source/utils/ - Cross-Cutting Utilities</b></summary>
...
<details>
<summary><b>📂 source/locale/ - Internationalization</b></summary>
...
<details>
<summary><b>Metadata Extraction (47 specialized modules)</b></summary>
...
<details>
<summary><b>Data Visualization (18 chart types)</b></summary>
...
<details>
<summary><b>Advanced Filters</b></summary>
...
> **Nota:** Este repositorio se refere à versão **v0.1.2.1** do Projeto Linceu Lighthouse. Apoya el proyecto y adquiere la versión de pago a través del enlace: [Instalar vía Microsoft Store](https://apps.microsoft.com/detail/9NN8Z5Z700TM)
...
Instalación:
    - Instala el archivo ejecutable del programa, sigue las instrucciones del instalador y ejecuta el programa.
...
Configuración Inicial:
    ...
    - Observa la barra lateral izquierda para acceder a las funciones principales.

Monitoreo de Directorios:
    1. Seleccionar un Directorio:
       - Haz clic en el botón "Seleccionar Directorio" o selecciona "Archivo → Seleccionar Directorio"
...
Interfaz Principal:
    - Barra de Menú: Acceso a todas as funções do programa
    - Barra Lateral: Botões de ações rápidas
    - Etiqueta de Directorio: Muestra el directorio monitorizado
    - Etiqueta de Resultado: Muestra el estado atual da operação
    - Tabla de Datos: Muestra todos los eventos de monitoreo
    - Barra de Progreso: Visível durante operações de longa duração
...
Filtros y Búsqueda:
    1. Filtros Rápidos:
       - En el menú "Configuración → Filtros", marca/desmarca tipos de operações
         (Movido, Renomeado, Adicionado, Excluído, Modificado)
...
Visualización de Estadísticas:
    ...
    - Guardar gráficos: Haz clic en "Guardar Todos" y selecciona destino

Exportación de Datos:
    - Haz clic en "Guardar Como" o "Archivo → Guardar Como"
    - Formatos disponibles:
      ...
      * XML (.xml)
      * Base de Datos (.db)
    - Para exportaciones futuras del mismo conjunto, usa "Archivo → Guardar"

Configuración de Columnas:
    - Accede a "Configuración → Configurar Columnas"
    - Marca/desmarca columnas deseadas en la tabla:
...
Cambio de Idioma:
    - Accede a "Opciones → Idioma" y selecciona el idioma deseado
    - El programa se reiniciará con el nuevo idioma después de la confirmación

Resolución de Problemas:
    1. El monitoreo no inicia:
        - Verifica los permisos de acceso al directorio
        - Asegúrate de que no hay otro programa monitoreando el mismo directorio
...
<details>
<summary><b>📂 source/gui/ - Capa de Interfaz Gráfica</b></summary>
...
<details>
<summary><b>📂 source/services/ - Capa de Lógica de Negocio</b></summary>
...
<details>
<summary><b>📂 source/ui/ - Componentes de Interfaz Avanzados</b></summary>
...
<details>
<summary><b>📂 source/data/ - Generación de Estadísticas y Gráficos</b></summary>
...
<details>
<summary><b>📂 source/tools/ - Herramientas y Utilitarios de UI</b></summary>
...
<details>
<summary><b>📂 source/utils/ - Utilitarios Transversales</b></summary>
...
<details>
<summary><b>📂 source/locale/ - Internacionalización</b></summary>
...
<details>
<summary><b>Monitoreo en Tiempo Real</b></summary>
...
<details>
<summary><b>Extracción de Metadatos (47 módulos especializados)</b></summary>
...
<details>
<summary><b>Visualización de Datos (18 tipos de gráficos)</b></summary>
...
<details>
<summary><b>Filtros Avanzados</b></summary>
...
<details>
<summary><b>Exportación de Datos</b></summary>
...
> **Note :** Ce référentiel fait référence à la version **v0.1.2.1** du projet Linceu Lighthouse. Soutenez le projet et achetez la version payante via le lien : [Installer via Microsoft Store](https://apps.microsoft.com/detail/9NN8Z5Z700TM)
...
Configuration Initiale :
    ...
    - La langue par défaut sera sélectionnée selon les paramètres du système.
...
Visualisation des Statistiques :
    ...
    - Graphiques disponibles :
      ...
      * Chronologie des Opérations : Ligne de temps des événements
      * Carte Arborescente : Visualisation de la taille par types
      * Distribution par Heure : Heures avec le plus d'opérations
      * Analyse de Pareto : Fréquence et pourcentage cumulé
      * Opérations par Jour : Opérations regroupées par date
...
<details>
<summary><b>📂 source/gui/ - Couche d'Interface Graphique</b></summary>
...
<details>
<summary><b>📂 source/services/ - Couche de Logique Métier</b></summary>
...
<details>
<summary><b>📂 source/ui/ - Composants d'Interface Avancés</b></summary>
...
<details>
<summary><b>📂 source/data/ - Génération de Statistiques et Graphiques</b></summary>
...
<details>
<summary><b>📂 source/tools/ - Outils et Utilitaires d'Interface</b></summary>
...
<details>
<summary><b>📂 source/utils/ - Utilitaires Transversaux</b></summary>
...
<details>
<summary><b>📂 source/locale/ - Internationalisation</b></summary>
...
<details>
<summary><b>Surveillance en Temps Réel</b></summary>
...
<details>
<summary><b>Extraction de Métadonnées (47 modules spécialisés)</b></summary>
...
<details>
<summary><b>Visualisation de Données (18 types de graphiques)</b></summary>
...
<details>
<summary><b>Filtres Avancés</b></summary>
...
<details>
<summary><b>Exportation de Données</b></summary>
...
<details>
<summary><b>Internationalisation</b></summary>
...
> **Nota:** Questo repository si riferisce alla versione **v0.1.2.1** del Progetto Linceu Lighthouse. Supporta il progetto e acquista la versione a pagamento tramite il link: [Installa via Microsoft Store](https://apps.microsoft.com/detail/9NN8Z5Z700TM)
...
Configurazione Iniziale:
    ...
    - La lingua predefinita verrà selezionata in base alle impostazioni del sistema.
...
Interfaccia Principale:
    ...
    - Barra di Avanzamento: Visibile durante operazioni di lunga durata
...
Filtri e Ricerca:
    1. Filtri Rapidi:
       - Nel menu "Impostazioni → Filtri" attiva/disattiva i tipi di operazioni
...
Visualizzazione delle Statistiche:
    ...
    - Grafici disponibili:
      ...
      * Linea Temporale delle Operazioni: Timeline degli eventi
      * Mappa ad Albero: Visualizzazione della dimensione per tipi
    ...
    - Salvare grafici: Fai clic su "Salva Tutto" e seleziona la destinazione
...
Configurazione delle Colonne:
    ...
    - Attiva/disattiva le colonne desiderate nella tabella:
...
Risoluzione dei Problemi:
    1. Il monitoraggio non si avvia:
        ...
        - Assicurati che non ci sia un altro programma che monitora la stessa directory
...
<details>
<summary><b>📂 source/gui/ - Livello Interfaccia Grafica</b></summary>
...
<details>
<summary><b>📂 source/services/ - Livello Logica di Business</b></summary>
...
<details>
<summary><b>📂 source/ui/ - Componenti Interfaccia Avanzati</b></summary>
...
<details>
<summary><b>📂 source/data/ - Generazione Statistiche e Grafici</b></summary>
...
<details>
<summary><b>📂 source/tools/ - Strumenti e Utilità UI</b></summary>
...
<details>
<summary><b>📂 source/utils/ - Utilità Trasversali</b></summary>
...
<details>
<summary><b>📂 source/locale/ - Internazionalizzazione</b></summary>
...
<details>
<summary><b>Monitoraggio in Tempo Reale</b></summary>
...
<details>
<summary><b>Estrazione Metadati (47 moduli specializzati)</b></summary>
...
<details>
<summary><b>Visualizzazione Dati (18 tipi di grafici)</b></summary>
...
<details>
<summary><b>Esportazione Dati</b></summary>
...
<details>
<summary><b>Internazionalizzazione</b></summary>
...
> **Hinweis:** Dieses Repository bezieht sich auf die Version **v0.1.2.1** des Linceu Lighthouse Projekts. Unterstützen Sie das Projekt und erwerben Sie die kostenpflichtige Version über den Link: [Über Microsoft Store installieren](https://apps.microsoft.com/detail/9NN8Z5Z700TM)
...
Ersteinrichtung:
    - Die Oberfläche wird mit einer leeren Überwachungstabelle angezeigt.
...
Hauptoberfläche:
    ...
    - Seitenleiste: Schaltflächen für schnelle Aktionen
    - Verzeichnisbezeichnung: Zeigt das überwachte Verzeichnis an
    - Ergebnisbezeichnung: Zeigt den aktuellen Status der Operation an
...
Filter und Suche:
    1. Schnellfilter:
       - Im Menü "Einstellungen → Filter" aktivieren/deaktivieren Sie Operationstypen
...
Statistikvisualisierung:
    - Zugriff über die Schaltfläche "Statistiken" oder "Datei → Statistiken"
    - Verfügbare Diagramme:
      * Operationsverteilung: Anteil jedes Operationstyps
      * Top 10 Dateitypen: Häufigste Dateitypen
      * Operations-Zeitleiste: Zeitleiste der Ereignisse
      * Baumkarte: Visualisierung der Größe nach Typen
      * Verteilung nach Stunde: Zeiten mit den meisten Operationen
      * Pareto-Analyse: Häufigkeit und kumulativer Prozentsatz
      * Operationen nach Tag: Nach Datum gruppierte Operationen
    - Diagramme speichern: Klicken Sie auf "Alle Speichern" und wählen Sie ein Ziel
...
Spaltenkonfiguration:
    ...
    - Aktivieren/Deaktivieren Sie gewünschte Spalten in der Tabelle:
...
<details>
<summary><b>📂 source/gui/ - Ebene der grafischen Benutzeroberfläche</b></summary>
...
<details>
<summary><b>📂 source/services/ - Ebene der Geschäftslogik</b></summary>
...
<details>
<summary><b>📂 source/ui/ - Erweiterte UI-Komponenten</b></summary>
...
<details>
<summary><b>📂 source/data/ - Erstellung von Statistiken und Diagrammen</b></summary>
...
<details>
<summary><b>📂 source/tools/ - UI-Werkzeuge und Hilfsprogramme</b></summary>
...
<details>
<summary><b>📂 source/utils/ - Querschnittliche Utilities</b></summary>
...
<details>
<summary><b>📂 source/locale/ - Internationalisierung</b></summary>
...
<details>
<summary><b>Echtzeitüberwachung</b></summary>
...
<details>
<summary><b>Metadatenextraktion (47 spezialisierte Module)</b></summary>
...
<details>
<summary><b>Datenvisualisierung (18 Diagrammtypen)</b></summary>
...
<details>
<summary><b>Erweiterte Filter</b></summary>
...
<details>
<summary><b>Datenexport</b></summary>
