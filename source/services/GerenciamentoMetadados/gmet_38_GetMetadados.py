...
from source.services.GerenciamentoMetadados import (
    ...
    try:
        ...
        if os.path.exists(caminho):
            ...
            try:
                ...
                if ext == '.dat':
                    from source.services.GerenciamentoMetadados.gmet_17_ExtrairMetadadosDadosEstruturados import extrair_metadados_dados_estruturados
