...
from source.Observador.GerenciamentoMetadados import (
    ...
    try:
        ...
        if os.path.exists(caminho):
            ...
            try:
                ...
                if ext == '.dat':
                    from source.Observador.GerenciamentoMetadados.gmet_17_ExtrairMetadadosDadosEstruturados import extrair_metadados_dados_estruturados
