...
class GerenciadorDesempenho:
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_01_criar_chart import _criar_chart
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_02_obter_percentual_disco import _obter_percentual_disco
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_03_atualizar import _atualizar
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_04_atualizar_series import _atualizar_series
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_05_on_pin_toggled import _on_pin_toggled
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_06_update_shared_dialog_title import _update_shared_dialog_title
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_07_rebuild_tab_mapping import _rebuild_tab_mapping
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_08_repin_all_from_shared import _repin_all_from_shared
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_09_detach_chart import _detach_chart
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_10_pin_chart import _pin_chart
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_11_aplicar_tema import _aplicar_tema
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_12_stop import stop
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_14_atualizar_traducoes import _atualizar_traducoes
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_15_update_disk_drive_mapping import _update_disk_drive_mapping
    from source.InterfaceCore.GerenciadorDesempenho.gdesemp_16_update_disk_chart_title import _update_disk_chart_title
