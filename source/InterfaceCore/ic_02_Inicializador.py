...
class Inicializador:
    ...
    def inicializar_gerenciadores(interface):
        try:
            from source.Observador.ob_02_BaseEvento import BaseEvento
            from source.Observador.ob_09_GerenciadorColunas import GerenciadorColunas
            from source.GerenciamentoUI.ui_01_GerenciadorBotoes import GerenciadorBotoes
            from source.GerenciamentoUI.ui_02_GerenciadorBotoesUI import GerenciadorBotoesUI
            from source.GerenciamentoUI.ui_03_GerenciadorMenusUI import GerenciadorMenusUI
            from source.GerenciamentoUI.ui_04_GerenciadorEventosUI import GerenciadorEventosUI
            from source.GerenciamentoUI.ui_05_GerenciadorProgressoUI import GerenciadorProgressoUI
            from source.GerenciamentoUI.ui_06_GerenciadorEstatisticasUI import GerenciadorEstatisticasUI
