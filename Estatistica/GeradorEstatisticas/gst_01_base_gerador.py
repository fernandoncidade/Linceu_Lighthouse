    ...
    def _obter_mapeamento_tipos(self):
        try:
            ...
            return {
                ...
                "Temporary": self.loc.get_text("file_temp"),
                "compressed": self.loc.get_text("file_compressed"),
                "Compressed": self.loc.get_text("file_compressed"),
                "archive": self.loc.get_text("archive"),
                "Archive": self.loc.get_text("archive"),
                ...
                "Temporário": self.loc.get_text("file_temp"),
                "compactado": self.loc.get_text("file_compressed"),
                "Compactado": self.loc.get_text("file_compressed"),
                "arquivo": self.loc.get_text("archive"),
                "Arquivo": self.loc.get_text("archive"),
                "backup": self.loc.get_text("file_backup"),
                "Backup": self.loc.get_text("file_backup"),
                "log": self.loc.get_text("file_log"),
                ...
                "Temporal": self.loc.get_text("file_temp"),
                "archivo": self.loc.get_text("archive"),
                "Archivo": self.loc.get_text("archive"),
                "comprimido": self.loc.get_text("file_compressed"),
                "Comprimido": self.loc.get_text("file_compressed"),
                ...
                "archive": self.loc.get_text("archive"),
                "Archive": self.loc.get_text("archive"),
                "compressé": self.loc.get_text("file_compressed"),
                "Compressé": self.loc.get_text("file_compressed"),
                ...
                "Temporaneo": self.loc.get_text("file_temp"),
                "archivio": self.loc.get_text("archive"),
                "Archivio": self.loc.get_text("archive"),
                "compresso": self.loc.get_text("file_compressed"),
                "Compresso": self.loc.get_text("file_compressed"),
                "backup": self.loc.get_text("file_backup"),
                "Backup": self.loc.get_text("file_backup"),
                "registro": self.loc.get_text("file_log"),
                ...
                "Temporär": self.loc.get_text("file_temp"),
                "archiv": self.loc.get_text("archive"),
                "Archiv": self.loc.get_text("archive"),
                "komprimiert": self.loc.get_text("file_compressed"),
                "Komprimiert": self.loc.get_text("file_compressed"),
