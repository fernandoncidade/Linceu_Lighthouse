        ...
        try:
            ...
            while parent_widget:
                if hasattr(parent_widget, 'gerenciador_menus_ui'):
                    ...
                    logger.debug("Janela principal encontrada através da hierarquia de widgets")
                    break
            ...
            if not main_window:
                for widget in QApplication.topLevelWidgets():
                    if hasattr(widget, 'gerenciador_menus_ui'):
                        main_window = widget
                        logger.debug("Janela principal encontrada nos widgets de topo")
                        break
            ...
            if not main_window:
                ...
                for widget in QApplication.topLevelWidgets():
                    if isinstance(widget, QMainWindow) and widget.menuBar():
                        main_window = widget
                        logger.debug("Encontrada janela principal alternativa (QMainWindow com menuBar)")
                        break
