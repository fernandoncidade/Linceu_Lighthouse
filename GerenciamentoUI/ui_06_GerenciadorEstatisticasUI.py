...
from GerenciamentoUI.GerenciamentoEstatisticasUI.geui_14_gerar_todos_graficos import (
    _gerar_todos_graficos, _enfileirar_grafico, _processar_proximo_grafico, 
